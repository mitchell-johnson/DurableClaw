/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f47e1cc5d86de0d812a48e7a90374a63)
...
interface __BaseEnv_Env {
	...
	NANO_CHAT_AGENT: DurableObjectNamespace<import("./src/server").NanoChatAgent>;
	RESEARCH_SUBAGENT: DurableObjectNamespace<import("./src/server").ResearchSubagent>;
	IDENTITY: DurableObjectNamespace<import("./src/server").IdentityDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "NanoChatAgent" | "ResearchSubagent" | "IdentityDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHAT_MODEL" | "BACKGROUND_MODEL" | "BATCH_MODEL" | "PROACTIVE_DISABLED" | "OPENROUTER_PROVIDER" | "BACKGROUND_REASONING_EFFORT">> {}
}
