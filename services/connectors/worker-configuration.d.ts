/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/connectors/wrangler.jsonc --env-interface=ConnectorEnv services/connectors/worker-configuration.d.ts` (hash: ee3a5588bbbf55b3ab97f2cfd153e79c)
// Runtime types generated with workerd@1.20260908.1 2026-08-15 nodejs_compat
interface __BaseEnv_ConnectorEnv {
	GOOGLE_CLIENT_ID: "";
	GOOGLE_REDIRECT_URI: "";
	...
	CONNECTOR_VAULT: DurableObjectNamespace<import("./src/index").ConnectorVault>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ConnectorVault";
	}
	interface Env extends __BaseEnv_ConnectorEnv {}
}
interface ConnectorEnv extends __BaseEnv_ConnectorEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GOOGLE_REDIRECT_URI" | "GOOGLE_WORKSPACE_DOMAIN" | "CONNECTOR_AUTH_SECRET" | "CONNECTOR_CREDENTIALS_SECRET" | "GOOGLE_CLIENT_SECRET">> {}
}
